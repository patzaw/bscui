"use strict";function Scui(e){this.zoom_min=null,this.zoom_step=null,this.zoom_max=null,this.clip=null,this.id=e,this.svg=null,this.main_group=null,this.sel_group=null,this.ui_elements=null,this.selectable=new Set,this.buttons=new Set,this.select_event=null,this.operate_event=null,this.hover_event=null,this.selected=new Set,this.hovered=null,this.clientX=null,this.clientY=null,this.button={n:0,id:null,click:null},this.ori_viewBox=null,this.png_scale=null,this.default_png_scale=null,this.zoom_current=null,this.stop_zoom=!1,this.moved=!1,this.init=function(e,t,i=!0,n="20px",o=.5,l=20,s=1.1,r=!1,a=1,c="orange",d={button:"yellow",selectable:"grey"},u=250,m=400){var v,h,p=this,_=document.getElementById(p.id),g=create_html_element("div"),b=(g.setAttribute("style","width:100%; height:100%; position:relative;"),g.innerHTML=e,g.children[0]),e=(b.removeAttribute("viewBox"),b.setAttribute("width","100%"),b.setAttribute("height","100%"),create_html_element("div")),n=(e.setAttribute("style","background-color: #3d3d3d2b;position: absolute;top: 0; left: 0;width: 20px; padding: 5px"),e.style.width=n,i&&g.appendChild(e),create_svg_icon("menu","Menu")),y=(e.appendChild(n),create_html_element("div")),i=(y.setAttribute("style","display: none;"),e.appendChild(y),create_html_element("p")),e=(i.setAttribute("height","20px"),y.appendChild(i),create_svg_icon("fit","Reset view")),w=(y.appendChild(e),create_svg_icon("zoom_in","Zoom in")),f=(y.appendChild(w),create_svg_icon("zoom_out","Zoom out")),i=(y.appendChild(f),y.appendChild(i.cloneNode(!0)),create_svg_icon("code","Save SVG")),x=(y.appendChild(i),create_svg_icon("photo","Save PNG")),z=(y.appendChild(x),create_svg_icon("scale","Scale PNG")),A=(z.setAttribute("style","width: 50%; margin-right: 0; margin-left: auto; display: block;"),y.appendChild(z),create_html_element("div")),B=(A.style.display="none",A.style.width="100px",y.appendChild(A),create_html_element("input")),k=(B.setAttribute("type","number"),B.setAttribute("min",0),B.setAttribute("step",1),B.value=a,B.setAttribute("style","text-align:right;"),B.style.width="50px",B.style.marginLeft="10px",B.style.display="inline",A.appendChild(B),create_svg_icon("close","Close")),B=(k.style.height="20px",k.style.display="inline",A.appendChild(k),this.png_scale=B,n.addEventListener("click",function(e){var t=y.style.display;y.style.display="none"==t?"block":"none"}),e.addEventListener("click",function(e){p.reset_view()}),w.addEventListener("click",function(e){p.zoom_in()}),f.addEventListener("click",function(e){p.zoom_out()}),x.addEventListener("click",function(e){p.save_png()}),i.addEventListener("click",function(e){p.save_svg()}),z.addEventListener("click",function(e){y.style.display;z.style.display="none",A.style.display="block"}),k.addEventListener("click",function(e){y.style.display;A.style.display="none",z.style.display="block"}),_.appendChild(g),b.querySelector("g")),n=create_svg_element("g");if(b.appendChild(n),p.svg=b,p.main_group=B,p.sel_group=n,p.ui_elements=t,p.select_event=new CustomEvent("elementSelected",{detail:{id:p.id}}),p.operate_event=new CustomEvent("elementOperated",{detail:{id:p.id}}),p.hover_event=new CustomEvent("elementHovered",{detail:{id:p.id}}),p.zoom_current=1,p.zoom_min=o,p.zoom_max=l,p.zoom_step=s,p.clip=r,p.default_png_scale=a,t)for(let e=0;e<t.id.length;e++){var C,E=t.id[e],N=("selectable"==t.ui_type[e]&&p.selectable.add(E),"button"==t.ui_type[e]&&p.buttons.add(E),b.getElementById(E));for(C in t)"opacity"==C&&(N.style.opacity=t.opacity[e]),"fill"==C&&(N.style.fill=t.fill[e]),"fill_opacity"==C&&(N.style.fillOpacity=t.fill_opacity[e]),"stroke"==C&&(N.style.stroke=t.stroke[e]),"stroke_width"==C&&(N.style.strokeWidth=t.stroke_width[e]),"stroke_opacity"==C&&(N.style.strokeOpacity=t.stroke_opacity[e])}v=_.id,new Promise(function(i){!function e(){var t=document.getElementById(v).querySelector("svg");t?i(t):requestAnimationFrame(e)}()}).then(function(e){var t=e.querySelector("g").getBoundingClientRect(),t="0 0 "+t.width+" "+t.height;e.setAttribute("viewBox",t),p.ori_viewBox=t}),b.addEventListener("wheel",function(e){p.wheel_zoom(e)}),b.addEventListener("mousedown",function(e){p.mouse_move(e)}),b.addEventListener("mousemove",function(e){var t,i,n=array_intersect(get_ancestors_ids(e.target),p.ui_elements.id)[0],o=b.getElementById("hovered_shape");n?(!o||n!=o.getAttribute("data-element")&&(p.sel_group.removeChild(o),!0))&&(t="none",p.selectable.has(n)&&(t="selectable"),p.buttons.has(n)&&(t="button"),t=d[t])&&((i=b.getElementById(n).cloneNode(!0)).setAttribute("data-element",n),i.id="hovered_shape",i.style.fill="none",i.style.stroke=t,i.style.visibility="visible",i.style.strokeWidth=i.style.strokeWidth+4,i.style.strokeOpacity=1,i.style.opacity=.5,i.style.pointerEvents="none",p.sel_group.appendChild(i)):o&&p.sel_group.removeChild(o),clearTimeout(h),h=setTimeout(function(){p.hovered=n,p.clientX=e.clientX,p.clientY=e.clientY,b.dispatchEvent(p.hover_event)},m)});var L,M=b.parentElement,e=_.id+"..ui_tooltip",S=create_html_element("div");return S.id=e,S.style.visibility="hidden",M.appendChild(S),S.addEventListener("mouseover",function(e){clearTimeout(h),p.hovered=S.getAttribute("data-element")}),b.addEventListener("elementHovered",function(e){var t,i;p.hovered?(t=!1,"visible"==S.style.visibility&&(S.getAttribute("data-element")!=p.hovered?S.style.visibility="hidden":t=!0),!t&&(t=p.ui_elements.id.indexOf(p.hovered),t=p.ui_elements.title[t])&&(S.innerHTML=t,t=p.clientX-M.getBoundingClientRect().left+M.scrollLeft+10,i=p.clientY-M.getBoundingClientRect().top+M.scrollTop+15,S.style.left=t+"px",S.style.top=i+"px",S.style.display="block",S.style.position="absolute",S.setAttribute("data-element",p.hovered),S.style.visibility="visible")):S.style.visibility="hidden"}),b.addEventListener("click",function(e){var t,i,n;p.moved||(i=array_intersect(t=get_ancestors_ids(e.target),p.selectable)[0],(n=array_intersect(t,p.buttons)[0])?(clearTimeout(L),L=setTimeout(function(){console.log(n),console.log("single click"),p.button.n=p.button.n+1,p.button.id=n,p.button.click="single",b.dispatchEvent(p.operate_event)},u)):(e.ctrlKey?i&&(p.selected.has(i)?p.selected.delete(i):p.selected.add(i)):i?(p.selected.clear(),p.selected.add(i)):p.selected.clear(),b.dispatchEvent(p.select_event)))}),b.addEventListener("elementSelected",function(e){var t=p.sel_group.children,i=[];Array.from(t).forEach(e=>{i.push(e.id),p.selected.has(e.id)||p.sel_group.removeChild(e)}),p.selected.forEach(e=>{i.includes(e)||((e=b.getElementById(e).cloneNode(!0)).id="selection.-_-."+e.id,e.style.fill="none",e.style.stroke=c,e.style.visibility="visible",e.style.strokeWidth=e.style.strokeWidth+2,e.style.strokeOpacity=1,e.style.opacity=.5,e.style.pointerEvents="none",p.sel_group.appendChild(e))})}),b.addEventListener("dblclick",function(e){p.moved||(clearTimeout(L),e=array_intersect(get_ancestors_ids(e.target),p.buttons)[0],p.button.n=p.button.n+1,p.button.id=e,p.button.click="double",b.dispatchEvent(p.operate_event))}),_},this.reset_view=function(){this.svg.setAttribute("viewBox",this.ori_viewBox),this.zoom_current=1},this.zoom_in=function(){var e=this,t=e.svg,i=t.getAttribute("viewBox").split(" "),n=Number(i[0]),o=Number(i[1]),l=Number(i[2]),i=Number(i[3]),s=e.zoom_step,r=e.zoom_current*s;r>e.zoom_max||r<e.zoom_min||(e.clip&&Math.abs(Math.log10(r))<.001?(e.zoom_current=1,t.setAttribute("viewBox",e.ori_viewBox)):(e.zoom_current=r,t.setAttribute("viewBox",n+" "+o+" "+l/s+" "+i/s)))},this.zoom_out=function(){var e=this,t=e.svg,i=t.getAttribute("viewBox").split(" "),n=Number(i[0]),o=Number(i[1]),l=Number(i[2]),i=Number(i[3]),s=1/e.zoom_step,r=e.zoom_current*s;r>e.zoom_max||r<e.zoom_min||(e.clip&&Math.abs(Math.log10(r))<.001?(e.zoom_current=1,t.setAttribute("viewBox",e.ori_viewBox)):(e.zoom_current=r,t.setAttribute("viewBox",n+" "+o+" "+l/s+" "+i/s)))},this.wheel_zoom=function(e){var t,i,n,o,l,s,r,a,c,d=this;d.stop_zoom?d.stop_zoom=!1:(t=d.svg,n=point_to_area_ref(i={x:e.clientX,y:e.clientY},t),a=t.getAttribute("viewBox").split(" "),o=Number(a[0]),l=Number(a[1]),r=Number(a[2]),a=Number(a[3]),t.getBoundingClientRect().width,c=d.zoom_step,0<e.deltaY&&(c=1/c),(s=d.zoom_current*c)>d.zoom_max||s<d.zoom_min||(d.clip&&Math.abs(Math.log10(s))<.001?(d.zoom_current=1,d.stop_zoom=!0,t.setAttribute("viewBox",d.ori_viewBox)):(d.zoom_current=s,t.setAttribute("viewBox",o+" "+l+" "+(d=r/c)+" "+(s=a/c)),a=o-((r=point_to_area_ref(i,t)).x-n.x),c=l-(r.y-n.y),t.setAttribute("viewBox",a+" "+c+" "+d+" "+s),e.stopPropagation(),e.preventDefault())))},this.mouse_move=function(e){var a,t,i,c,d,n,u,m,v,h,p=this;function o(e){var r=e;v||(v=!0,setTimeout(function(){var e=a.getAttribute("viewBox").split(" "),t=Number(e[0]),i=Number(e[1]),n=Number(e[2]),e=Number(e[3]),o={x:r.clientX,y:r.clientY},l=h.x-o.x,s=h.y-o.y;a.setAttribute("viewBox",t+m*l/c+" "+(i+u*s/d)+" "+n+" "+e),p.moved=!0,h=o,v=!1},40))}p.moved=!1,0!=e.button||p.clip&&1==p.zoom_current||(i=(a=p.svg).getAttribute("viewBox").split(" "),t=Number(i[2]),i=Number(i[3]),n=a.getBoundingClientRect(),c=n.width,d=n.height,n=c/d,Math.max(c,d),n<=t/i?u=(m=t)/n:m=(u=i)*n,v=!1,h={x:e.clientX,y:e.clientY},a.addEventListener("mousemove",o),a.addEventListener("mouseup",function(e){a.removeEventListener("mousemove",o),e.stopPropagation(),e.preventDefault()}),e.stopPropagation(),e.preventDefault())},this.save_svg=function(){var e=this.svg.cloneNode(!0),e=(e.setAttribute("viewBox",this.ori_viewBox),e.outerHTML),e="data:image/svg+xml;base64,"+btoa('<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'+e),t=document.querySelector("body"),i=t.appendChild(create_html_element("a"));i.style.visibility="hidden",i.setAttribute("href",e),i.setAttribute("download","image.svg"),i.click(),t.removeChild(i)},this.save_png=function(){var e=this.svg.cloneNode(!0);e.setAttribute("version",1.1),e.setAttribute("xmlns","http://www.w3.org/2000/svg");var t=(t=Number(this.png_scale.value))||this.default_png_scale,i=this.ori_viewBox.split(" "),n=Number(i[0]),o=Number(i[1]),l=Number(i[2]),i=Number(i[3]),n=(e.setAttribute("width",l),e.setAttribute("height",i),e.setAttribute("viewBox",n+" "+o+" "+l+" "+i),e.outerHTML),n="data:image/svg+xml;base64,"+btoa(n),s=l*t,r=i*t,a=create_html_element("canvas"),c=(a.setAttribute("width",s),a.setAttribute("height",r),a.getContext("2d")),d=new Image;d.onload=function(){c.drawImage(d,0,0,s,r);var e=a.toDataURL("image/png"),t=document.querySelector("body"),i=t.appendChild(create_html_element("a"));i.style.visibility="hidden",i.setAttribute("download","image.png"),i.setAttribute("href",e),i.click(),t.removeChild(i)},d.src=n}}function create_svg_icon(e,t,i="#FFFFFF00"){for(var n=[{name:"menu",svg:`
   ...
   `,l.setAttribute("viewBox",n[o].viewBox),l}function create_html_element(e){return document.createElementNS("http://www.w3.org/1999/xhtml",e)}function create_svg_element(e){return document.createElementNS("http://www.w3.org/2000/svg",e)}function point_to_area_ref(e,t){return new DOMPoint(e.x,e.y).matrixTransform(t.getScreenCTM().inverse())}function get_ancestors_ids(e){for(var t=[e.id],i=e.parentNode;null!==i;)t.push(i.id),i=i.parentNode;return t}function array_intersect(e,t){var e=new Set(e),i=new Set(t);return[...e].filter(e=>i.has(e))}