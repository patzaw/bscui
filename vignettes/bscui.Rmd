...
The application is divided in three main parts:

- On the left: the anatomical diagram 
- On the top right: a table to choose the organs and configure the interactions
- On the bottom right: text outputs showing the input values that are updated
when interacting with the diagram and interfaces to interact with the anatomical
diagram
