"use strict";function Scui(e){this.zoom_min=null,this.zoom_step=null,this.zoom_max=null,this.clip=null,this.id=e,this.svg=null,this.main_group=null,this.sel_group=null,this.ui_elements=null,this.selectable=new Set,this.buttons=new Set,this.select_event=null,this.operate_event=null,this.hover_event=null,this.selected=new Set,this.hovered=null,this.clientX=null,this.clientY=null,this.button={n:0,id:null,click:null},this.ori_viewBox=null,this.png_scale=null,this.default_png_scale=null,this.zoom_current=null,this.stop_zoom=!1,this.moved=!1,this.init=function(e,t,i,n=!0,o="20px",l=.5,s=20,r=1.1,a=!1,c=1,d="orange",u={button:"yellow",selectable:"grey"},m=250,v=400){var h,p,_=this,g=document.getElementById(_.id),b=create_html_element("div"),y=(b.setAttribute("style","width:100%; height:100%; position:relative;"),b.innerHTML=e,b.children[0]),e=(y.removeAttribute("viewBox"),y.setAttribute("width","100%"),y.setAttribute("height","100%"),create_html_element("div")),o=(e.setAttribute("style","background-color: #3d3d3d2b;position: absolute;top: 0; left: 0;width: 20px; padding: 5px"),e.style.width=o,n&&b.appendChild(e),create_svg_icon("menu","Menu")),w=(e.appendChild(o),create_html_element("div")),n=(w.setAttribute("style","display: none;"),e.appendChild(w),create_html_element("p")),e=(n.setAttribute("height","20px"),w.appendChild(n),create_svg_icon("fit","Reset view")),f=(w.appendChild(e),create_svg_icon("zoom_in","Zoom in")),x=(w.appendChild(f),create_svg_icon("zoom_out","Zoom out")),n=(w.appendChild(x),w.appendChild(n.cloneNode(!0)),create_svg_icon("code","Save SVG")),z=(w.appendChild(n),create_svg_icon("photo","Save PNG")),A=(w.appendChild(z),create_svg_icon("scale","Scale PNG")),B=(A.setAttribute("style","width: 50%; margin-right: 0; margin-left: auto; display: block;"),w.appendChild(A),create_html_element("div")),E=(B.style.display="none",B.style.width="100px",w.appendChild(B),create_html_element("input")),C=(E.setAttribute("type","number"),E.setAttribute("min",0),E.setAttribute("step",1),E.value=c,E.setAttribute("style","text-align:right;"),E.style.width="50px",E.style.marginLeft="10px",E.style.display="inline",B.appendChild(E),create_svg_icon("close","Close")),E=(C.style.height="20px",C.style.display="inline",B.appendChild(C),this.png_scale=E,o.addEventListener("click",function(e){var t=w.style.display;w.style.display="none"==t?"block":"none"}),e.addEventListener("click",function(e){_.reset_view()}),f.addEventListener("click",function(e){_.zoom_in()}),x.addEventListener("click",function(e){_.zoom_out()}),z.addEventListener("click",function(e){_.save_png()}),n.addEventListener("click",function(e){_.save_svg()}),A.addEventListener("click",function(e){w.style.display;A.style.display="none",B.style.display="block"}),C.addEventListener("click",function(e){w.style.display;B.style.display="none",A.style.display="block"}),g.appendChild(b),y.querySelector("g")),o=create_svg_element("g");if(y.appendChild(o),_.svg=y,_.main_group=E,_.sel_group=o,_.ui_elements=t,_.select_event=new CustomEvent("elementSelected",{detail:{id:_.id}}),_.operate_event=new CustomEvent("elementOperated",{detail:{id:_.id}}),_.hover_event=new CustomEvent("elementHovered",{detail:{id:_.id}}),_.zoom_current=1,_.zoom_min=l,_.zoom_max=s,_.zoom_step=r,_.clip=a,_.default_png_scale=c,t)for(let e=0;e<t.id.length;e++){var N=t.id[e];"selectable"==t.ui_type[e]&&_.selectable.add(N),"button"==t.ui_type[e]&&_.buttons.add(N)}if(i)for(let e=0;e<i.id.length;e++){var k,L=i.id[e],M=y.getElementById(L);for(k in i)M.style[k]=i[k][e]}h=g.id,new Promise(function(i){!function e(){var t=document.getElementById(h).querySelector("svg");t?i(t):requestAnimationFrame(e)}()}).then(function(e){var t=e.querySelector("g").getBoundingClientRect(),t="0 0 "+t.width+" "+t.height;e.setAttribute("viewBox",t),_.ori_viewBox=t}),y.addEventListener("wheel",function(e){_.wheel_zoom(e)}),y.addEventListener("mousedown",function(e){_.mouse_move(e)}),y.addEventListener("mousemove",function(e){var t,i,n=array_intersect(get_ancestors_ids(e.target),_.ui_elements.id)[0],o=y.getElementById("hovered_shape");n?(!o||n!=o.getAttribute("data-element")&&(_.sel_group.removeChild(o),!0))&&(t="none",_.selectable.has(n)&&(t="selectable"),_.buttons.has(n)&&(t="button"),t=u[t])&&((i=y.getElementById(n).cloneNode(!0)).setAttribute("data-element",n),i.id="hovered_shape",i.style.fill="none",i.style.stroke=t,i.style.visibility="visible",i.style.strokeWidth=i.style.strokeWidth+4,i.style.strokeOpacity=1,i.style.opacity=.5,i.style.pointerEvents="none",_.sel_group.appendChild(i)):o&&_.sel_group.removeChild(o),clearTimeout(p),p=setTimeout(function(){_.hovered=n,_.clientX=e.clientX,_.clientY=e.clientY,y.dispatchEvent(_.hover_event)},v)});var S,T=y.parentElement,e=g.id+"..ui_tooltip",H=create_html_element("div");return H.id=e,H.style.visibility="hidden",T.appendChild(H),H.addEventListener("mouseover",function(e){clearTimeout(p),_.hovered=H.getAttribute("data-element")}),y.addEventListener("elementHovered",function(e){var t,i;_.hovered?(t=!1,"visible"==H.style.visibility&&(H.getAttribute("data-element")!=_.hovered?H.style.visibility="hidden":t=!0),!t&&(t=_.ui_elements.id.indexOf(_.hovered),t=_.ui_elements.title[t])&&(H.innerHTML=t,t=_.clientX-T.getBoundingClientRect().left+T.scrollLeft+10,i=_.clientY-T.getBoundingClientRect().top+T.scrollTop+15,H.style.left=t+"px",H.style.top=i+"px",H.style.display="block",H.style.position="absolute",H.setAttribute("data-element",_.hovered),H.style.visibility="visible")):H.style.visibility="hidden"}),y.addEventListener("click",function(e){var t,i,n;_.moved||(i=array_intersect(t=get_ancestors_ids(e.target),_.selectable)[0],(n=array_intersect(t,_.buttons)[0])?(clearTimeout(S),S=setTimeout(function(){console.log(n),console.log("single click"),_.button.n=_.button.n+1,_.button.id=n,_.button.click="single",y.dispatchEvent(_.operate_event)},m)):(e.ctrlKey?i&&(_.selected.has(i)?_.selected.delete(i):_.selected.add(i)):i?(_.selected.clear(),_.selected.add(i)):_.selected.clear(),y.dispatchEvent(_.select_event)))}),y.addEventListener("elementSelected",function(e){var t=_.sel_group.children,i=[];Array.from(t).forEach(e=>{i.push(e.id),_.selected.has(e.id)||_.sel_group.removeChild(e)}),_.selected.forEach(e=>{i.includes(e)||((e=y.getElementById(e).cloneNode(!0)).id="selection.-_-."+e.id,e.style.fill="none",e.style.stroke=d,e.style.visibility="visible",e.style.strokeWidth=e.style.strokeWidth+2,e.style.strokeOpacity=1,e.style.opacity=.5,e.style.pointerEvents="none",_.sel_group.appendChild(e))})}),y.addEventListener("dblclick",function(e){_.moved||(clearTimeout(S),e=array_intersect(get_ancestors_ids(e.target),_.buttons)[0],_.button.n=_.button.n+1,_.button.id=e,_.button.click="double",y.dispatchEvent(_.operate_event))}),g},this.update_selection=function(e){var t=this.svg;this.selected=new Set(array_intersect(e,this.selectable)),t.dispatchEvent(this.select_event)},this.reset_view=function(){this.svg.setAttribute("viewBox",this.ori_viewBox),this.zoom_current=1},this.zoom_in=function(){var e=this,t=e.svg,i=t.getAttribute("viewBox").split(" "),n=Number(i[0]),o=Number(i[1]),l=Number(i[2]),i=Number(i[3]),s=e.zoom_step,r=e.zoom_current*s;r>e.zoom_max||r<e.zoom_min||(e.clip&&Math.abs(Math.log10(r))<.001?(e.zoom_current=1,t.setAttribute("viewBox",e.ori_viewBox)):(e.zoom_current=r,t.setAttribute("viewBox",n+" "+o+" "+l/s+" "+i/s)))},this.zoom_out=function(){var e=this,t=e.svg,i=t.getAttribute("viewBox").split(" "),n=Number(i[0]),o=Number(i[1]),l=Number(i[2]),i=Number(i[3]),s=1/e.zoom_step,r=e.zoom_current*s;r>e.zoom_max||r<e.zoom_min||(e.clip&&Math.abs(Math.log10(r))<.001?(e.zoom_current=1,t.setAttribute("viewBox",e.ori_viewBox)):(e.zoom_current=r,t.setAttribute("viewBox",n+" "+o+" "+l/s+" "+i/s)))},this.wheel_zoom=function(e){var t,i,n,o,l,s,r,a,c,d=this;d.stop_zoom?d.stop_zoom=!1:(t=d.svg,n=point_to_area_ref(i={x:e.clientX,y:e.clientY},t),a=t.getAttribute("viewBox").split(" "),o=Number(a[0]),l=Number(a[1]),r=Number(a[2]),a=Number(a[3]),t.getBoundingClientRect().width,c=d.zoom_step,0<e.deltaY&&(c=1/c),(s=d.zoom_current*c)>d.zoom_max||s<d.zoom_min||(d.clip&&Math.abs(Math.log10(s))<.001?(d.zoom_current=1,d.stop_zoom=!0,t.setAttribute("viewBox",d.ori_viewBox)):(d.zoom_current=s,t.setAttribute("viewBox",o+" "+l+" "+(d=r/c)+" "+(s=a/c)),a=o-((r=point_to_area_ref(i,t)).x-n.x),c=l-(r.y-n.y),t.setAttribute("viewBox",a+" "+c+" "+d+" "+s),e.stopPropagation(),e.preventDefault())))},this.mouse_move=function(e){var a,t,i,c,d,n,u,m,v,h,p=this;function o(e){var r=e;v||(v=!0,setTimeout(function(){var e=a.getAttribute("viewBox").split(" "),t=Number(e[0]),i=Number(e[1]),n=Number(e[2]),e=Number(e[3]),o={x:r.clientX,y:r.clientY},l=h.x-o.x,s=h.y-o.y;a.setAttribute("viewBox",t+m*l/c+" "+(i+u*s/d)+" "+n+" "+e),p.moved=!0,h=o,v=!1},40))}p.moved=!1,0!=e.button||p.clip&&1==p.zoom_current||(i=(a=p.svg).getAttribute("viewBox").split(" "),t=Number(i[2]),i=Number(i[3]),n=a.getBoundingClientRect(),c=n.width,d=n.height,n=c/d,Math.max(c,d),n<=t/i?u=(m=t)/n:m=(u=i)*n,v=!1,h={x:e.clientX,y:e.clientY},a.addEventListener("mousemove",o),a.addEventListener("mouseup",function(e){a.removeEventListener("mousemove",o),e.stopPropagation(),e.preventDefault()}),e.stopPropagation(),e.preventDefault())},this.save_svg=function(){var e=this.svg.cloneNode(!0),e=(e.setAttribute("viewBox",this.ori_viewBox),e.outerHTML),e="data:image/svg+xml;base64,"+btoa('<?xml version="1.0" encoding="UTF-8" standalone="yes"?>'+e),t=document.querySelector("body"),i=t.appendChild(create_html_element("a"));i.style.visibility="hidden",i.setAttribute("href",e),i.setAttribute("download","image.svg"),i.click(),t.removeChild(i)},this.save_png=function(){var e=this.svg.cloneNode(!0);e.setAttribute("version",1.1),e.setAttribute("xmlns","http://www.w3.org/2000/svg");var t=(t=Number(this.png_scale.value))||this.default_png_scale,i=this.ori_viewBox.split(" "),n=Number(i[0]),o=Number(i[1]),l=Number(i[2]),i=Number(i[3]),n=(e.setAttribute("width",l),e.setAttribute("height",i),e.setAttribute("viewBox",n+" "+o+" "+l+" "+i),e.outerHTML),n="data:image/svg+xml;base64,"+btoa(n),s=l*t,r=i*t,a=create_html_element("canvas"),c=(a.setAttribute("width",s),a.setAttribute("height",r),a.getContext("2d")),d=new Image;d.onload=function(){c.drawImage(d,0,0,s,r);var e=a.toDataURL("image/png"),t=document.querySelector("body"),i=t.appendChild(create_html_element("a"));i.style.visibility="hidden",i.setAttribute("download","image.png"),i.setAttribute("href",e),i.click(),t.removeChild(i)},d.src=n}}function create_svg_icon(e,t,i="#FFFFFF00"){for(var n=[{name:"menu",svg:`
