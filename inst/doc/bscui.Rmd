...
Building the figure and inserting it in Shiny user interface is straightforward
and relies on the `bscuiOutput()` and `renderBscui()` functions:
...
- `input$bscuiID_operated` report operated button elements
